    						...
    						<div class="flex-container no-margin user">
    							<div class="flex-small-item">
    								<div class="relative padding-bottom" style="width: 100%;">
    									<a href="add-type.php"><i class="fa fa-plus fa-1x" aria-hidden="true" style="margin-right:5px;"></i></a>
                            ...
                            <div class="col-sm-12">
                                <div class="dataTables_scroll"  id="table_wrapper">
                                    <div class="dataTables_scrollBody" style="position: relative; overflow: auto; height: 64vh; width: 100%;">
                                        <table class="table table-hover data-table" data-label="Type Name" style="width: 100%;" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    <th>Name</th>
                                                    <th>Date Added</th>
                                            ...
                                            <?php
                                                foreach($types as $type){
                                                    echo"<tr class='odd' id='row-" . $type["id"] . "'>";
    												echo"<td>". $type["name"] ."</td>";
    												echo"<td>". $type["date_added"] ."</td>";
    												echo'<td class="action">
                                                            <div class="table-data-feature">
                                                                <a href="edit-type.php?id=' . $type["id"] . '" class="item" data-toggle="tooltip" data-placement="top" title="Edit Type">
                                                                <i class="fa fa-pencil fa-2x" aria-hidden="true" style="margin-right:10px;"></i>
                                                                </a>
                                                                <a href="delete_action.php?id=' . $type["id"] . '&type=types" class="item" data-toggle="tooltip" data-placement="top" title="Delete Type">
