    					...
    					<form action="" class="form-horizontal" id="fpwd-form" method="post" role="form">
    						<div class="form-group">
    							<div class="login-input-fields">
    								<input class="form-control center-block login-placeholder-text square-form-field" type="text" name="useremail" placeholder="Enter your email address..." value="" />
    							</div>
    						</div>
                            <div class="form-group">
                                <div class="half-col">
                                ...
                                <div class="half-col">
                                    <div class="">
                                        <h6><span class="text-center login-links" id="login-forgot-password"><a href="login.php">Go Back</a></span></h6>
                                    </div>                                
                                </div>                                
                            </div>
    						<!-- <div class="form-group">
